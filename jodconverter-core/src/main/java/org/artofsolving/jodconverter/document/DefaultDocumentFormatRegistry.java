...
public class DefaultDocumentFormatRegistry extends SimpleDocumentFormatRegistry {
	...
	public DefaultDocumentFormatRegistry() {
		...
		pdf.setStoreProperties(DocumentFamily.WEB, Collections.singletonMap("FilterName", "writer_web_pdf_Export"));
		addFormat(pdf);
		...
		odt.setStoreProperties(DocumentFamily.WEB, Collections.singletonMap("FilterName", "writerweb8_writer"));
		addFormat(odt);
		...
		sxw.setStoreProperties(DocumentFamily.WEB, Collections.singletonMap("FilterName", "writer_web_StarOffice_XML_Writer"));
		addFormat(sxw);
		...
		Map<String,Object> txtWebStoreProperties = new LinkedHashMap<String,Object>(txtLoadAndStoreProperties);
		txtWebStoreProperties.put("FilterName", "Text (encoded) (StarWriter/Web)");
		txt.setStoreProperties(DocumentFamily.WEB, txtWebStoreProperties);
